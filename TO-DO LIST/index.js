...
function mostrarTarefa() {
    ...
    <li class="tarefa">${item}</li>

            <button id="check"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <button  id="btnx" title="Clique aqui para excluir tarefa"><svg
